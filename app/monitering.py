...
def get_logger(name:str="production-api")->logging.Logger:
    """ Create a structred JSON logger ."""
...
class MetricsCollector:
    """Collect and aggregate metrics.
       In Produciton ,replace with Prometheus client:
...
def demo_logger():
    ...
    logger.warning('Rate limit apporaching ',extra={
        'extra_data':{
            'current_rate':100,'limit':80
        }
    })
